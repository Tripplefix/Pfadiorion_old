...
class View {
     ...
     */
    public function render($filename, $admin = false, $special_page = false) {
        ...
        if ($special_page == true) {
            ...
            require 'views/admin/_templates/header.php';
            require 'views/admin/' . $filename . '.php';
            require 'views/admin/_templates/footer.php';
